...
.USAGE
  ...
  # Show every matching operator for heuristic sections (instead of grouped findings):
...
function Get-SqlPlanInsights {
  ...
  param(
    ...
    [string]$Path = 'C:\Users\dbsa\Documents\ExecutionPlan1.xml',
